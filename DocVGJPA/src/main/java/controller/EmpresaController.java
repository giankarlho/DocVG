...
import model.dao.EmpresaFacade;
...
public class EmpresaController implements Serializable {
    ...
    @EJB
    private model.dao.EmpresaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("EmpresaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("EmpresaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("EmpresaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
