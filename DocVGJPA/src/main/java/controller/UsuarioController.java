...
import model.dao.UsuarioFacade;
...
public class UsuarioController implements Serializable {
    ...
    public String iniciarSesion(){
        ...
        try {
            us = ejbFacade.iniciarSesion(usuario);
            if(us!=null){
                redireccion ="/index";
                System.out.println("Que pasó?!!!!");
            }else{
                FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(FacesMessage.SEVERITY_WARN, "Usuario incorrecto"," Denegación de acceso"));  
            } 
        } catch (Exception e) {
